...
import MenuItem from "components/client/Header/MenuItem";
...
const menuData = [
    {
        label: routerName.aboutUs.title,
        link: routerName.aboutUs.slug
    },
    {
        label: "Dịch vụ",
        children: [
            {
                label: routerName.servicesCrossBorderEcommerce.title,
                link: routerName.servicesCrossBorderEcommerce.slug
            },
            {
                label: routerName.servicesCrossBorderTransportation.title,
                link: routerName.servicesCrossBorderTransportation.slug
            }
        ],
    },
        ...
        <header>
            <div className={cx("container-header")}>
                ...
                <div className={cx("action-header")}>
                    ...
                    <Link to={routerName.contactSales.slug} className={cx("item-menu-header", "header-contact")}
                          aria-label={routerName.contactSales.title}>
                        {routerName.contactSales.title}
                    </Link>
                </div>
            </div>
        </header>
