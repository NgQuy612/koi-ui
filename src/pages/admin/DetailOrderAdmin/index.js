...
function DetailOrderAdmin() {
  ...
  const handleStaffChange = (e) => {
    ...
    console.log(
      `http://localhost:8081/api/v1/order/deliver/${id}?deliveryId=${selectedStaffId}`
    );
    ...
    axios
      ...
      .then(() => toast.success("Staff assigned successfully"))
            ...
            <div className={cx("box-widt-48")}>
              <div className={cx("box-input-form-order", "box-widt-48")}>
                ...
                >
                  ...
                  <option value="2" selected={formData.deliverId === "2"}>
                    Staff Deliver 1
                  </option>
                  <option value="3" selected={formData.deliverId === "3"}>
                    Staff Deliver 2
                  </option>
                </select>
              </div>
